                ...
                <div class="col-6">
                    ...
                    <form action="{{ route('books.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="book_id" type="number" class="form-control" value="{{ old('book_id') }}">
                        </div>
                        @error('book_id')
                            <a style="color: red">{{ $message }}</a>
                        @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input name="number_page" type="text" class="form-control" value="{{ old('number_page') }}">
                        </div>
                        @error('number_page')
                            <a style="color: red">{{ $message }}</a>
                        @enderror
                        <div class="mb-3">
                            ...
                            <input name="year" type="date" class="form-control" value="{{ old('year') }}">
                        </div>
                        @error('year')
                            <a style="color: red">{{ $message }}</a>
                        @enderror
